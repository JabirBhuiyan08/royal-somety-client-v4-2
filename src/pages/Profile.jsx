...
import { Camera, Copy, CheckCircle, Phone, Droplets, Calendar, Edit2, LogOut, Save, X, Wallet, Users, TrendingUp } from 'lucide-react';
...
const Profile = () => {
  ...
  // Fetch total balance (for all users) and admin stats (only for admin)
  ...
  // Get total balance - for all users show sum of all members, for admin show both
    ...
    <div className="pb-24">
      ...
      <div className="relative h-32 bg-gradient-to-r from-blue-600 to-blue-700 overflow-hidden">
        ...
        <button 
          ...
          className="absolute top-3 right-3 w-8 h-8 rounded-full bg-black/40 hover:bg-black/50 backdrop-blur-sm flex items-center justify-center transition-all active:scale-95"
        >
      ...
      <div className="px-4">
          ...
          <div className="flex items-end gap-3 mb-3">
            ...
            <div className="relative">
              ...
              <button 
                ...
                className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-blue-600 hover:bg-blue-700 flex items-center justify-center shadow-md transition-all active:scale-95"
              >
            ...
            <button 
              ...
              className="w-8 h-8 rounded-xl bg-gray-50 border border-gray-200 hover:bg-gray-100 flex items-center justify-center transition-all active:scale-95"
            >
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          {/* Total Balance - Shows all members total + personal */}
          <div className="bg-white rounded-xl p-3 text-center shadow-sm border border-gray-100">
            ...
            {myBalance > 0 && (
              <p className="text-xs font-semibold text-blue-600 mt-1">আপনার: ৳{myBalance.toLocaleString()}</p>
            )}
          </div>
          ...
          <div className="bg-white rounded-xl p-3 text-center shadow-sm border border-gray-100">
            ...
            <p className="text-base font-bold text-blue-600">
              ৳{(dbUser?.monthlyDeposit || 0).toLocaleString()}
            </p>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <select 
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none bg-white"
                >
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-700">{dbUser?.phone || 'N/A'}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-700">
                    {dbUser?.createdAt ? new Date(dbUser.createdAt).toLocaleDateString('bn-BD') : 'N/A'}
                  </p>
                </div>
              </div>
            </div>
        ...
        <button 
          ...
          className="w-full py-3 rounded-xl flex items-center justify-center gap-2 bg-red-50 border border-red-200 text-red-600 font-semibold text-sm hover:bg-red-100 active:scale-95 transition-all"
        >
          <LogOut size={16} />
          <span>লগআউট</span>
        </button>
